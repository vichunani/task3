<?php
//Тестовое задание
//Создать функцию которая бы реверсировала порядок букв в словах строки.
//Например       "Привет! Как дела? Давненько не виделись."
//Преобразовать  "Тевирп! Как алед? Окьненвад ен ьсиледив."
